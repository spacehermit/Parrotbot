...
class ServerLed(object):
	...
	if self.button_switch == 1:
        ...
        html = open('C:\Python27\Projects\MIP\MIP.html','r').read()
...
conf = {
        ...
        '/images': { #images served as static files
            ...
            'tools.staticdir.dir': 'C:\Python27\Projects\MIP\images'
        },

        '/favicon.ico': {  #favorite icon
            'tools.staticfile.on': True,  
            'tools.staticfile.filename': 'C:\Python27\Projects\MIP\images\MIP.ico'
        }
    }
